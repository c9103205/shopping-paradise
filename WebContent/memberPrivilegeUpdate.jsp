			...
			<div class="inner">
				...
				<nav id="menu">
					...
					<ul>
						...
						<%
						if(session.getAttribute("login")!=null){
							AccountBean accountLogin =(AccountBean) session.getAttribute("login");
							if(accountLogin.getPrivilege()!=0){
								out.print("<li><span class='opener'>後台管理</span><ul>");
								if((accountLogin.getPrivilege()&1)!=0)	
									out.print("<li><a href='Commodity?account=admin'>商品管理</a></li>");
								if((accountLogin.getPrivilege()&2)!=0)
									out.print("<li><a href='OrderAdmin'>訂單管理</a></li>");
								if((accountLogin.getPrivilege()&4)!=0)	
									out.print("<li><a href='MemberAdmin'>會員管理</a></li>");
								if((accountLogin.getPrivilege()&8)!=0)
